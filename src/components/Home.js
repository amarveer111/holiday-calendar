...
const Home = () => {
  ...
  const [myH, setmyH] = useState([]);
  const [myHDetail, setmyHDetail] = useState([]);
    ...
    fetch(
      ...
      .then(res => {
        res.json().then(result => {
          setmyH(result.response.holidays);
          setIsLoading(false);
        });
      })
      .catch(error => {
  ...
  const HHD = (day, month, year) => {
    fetch(
      ...
      .then(res => {
        res.json().then(result => {
          setIsLoading(false);
          return setmyHDetail(result.response.holidays);
        });
      })
      .catch(error => {
        console.log(error);
